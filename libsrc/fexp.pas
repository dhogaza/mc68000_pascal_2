{ NOTICE OF COPYRIGHT AND OWNERSHIP OF SOFTWARE:
  ...
  Single Precision Real Exponential Function

 Last modified by KRIS on 26-Nov-1990 13:56:32
 Purpose:
...
{$ident='Single Precision Real Exponential Function'}
...
function p_fexp {( realval: real) : real} ;
  ...
  begin
    if realval < smallX then p_fexp := 0.0
    else if abs(realval) < eps then p_fexp := 1.0
    else
      begin

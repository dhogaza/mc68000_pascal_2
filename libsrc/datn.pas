{ NOTICE OF COPYRIGHT AND OWNERSHIP OF SOFTWARE:
  ...
  Double Precision Real Arctangent Function

 Last modified by KRIS on 26-Nov-1990 14:00:39
 Purpose:
...
{$ident='Double Precision Real Arctangent Function'}
